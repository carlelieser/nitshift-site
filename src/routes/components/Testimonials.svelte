			...
			<div slot="right" class="space-y-4 md:space-y-8">
				...
				<div class="grid grid-cols-1 xl:grid-cols-2 grid-rows-2 gap-10 gap-y-16 pt-12">
					<Testimonial
						...
						message="Before Glimmr, adjusting my monitor's brightness was a daily hassle, especially when dealing with the tiny buttons on the back of my screen. Now, I can easily manage everything from my desktop. It's not just convenient; it's a relief."
						avatar={mia}
					/>
					<Testimonial
						name="Jordan M."
					...
					<Testimonial
						...
						message="I'm all about aesthetics, and Glimmr is not only a lifesaver for managing my dual monitors but it's also beautifully designed. It fits perfectly into my workflow and my desktop setup. Finally, an app that gets it right."
						avatar={riley}
					/>
					<Testimonial
						name="Alex D."
						title="IT Professional"
						message="Dealing with multiple monitors used to mean constantly fiddling with settings to get a uniform look. With Glimmr, it's a one-time setup, and everything is synchronized perfectly. It's such a simple solution to what was an ongoing frustration."
						avatar={alex}
					/>
				</div>
			</div>
